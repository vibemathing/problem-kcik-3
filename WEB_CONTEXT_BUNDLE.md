...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "kcik-3",
      "KCIK Problem 3: AME state for four six-level systems / quantum Euler officers"
    ],
    "allowed_axioms": [
      "none"
    ],
    ...
    "statement": {
      "language": "en",
      "text": "Draft bounty intake target(s): KCIK Problem 3: AME state for four six-level systems / quantum Euler officers. The exact mathematical statement, quantifiers, definitions, assumptions, and acceptance conditions have not yet been frozen; this draft is not research-admitted.",
      "version": 1
    },
    "title": "KCIK Problem 3: AME state for four six-level systems / quantum Euler officers",
    "updated_at": "2026-09-08T08:24:29Z"
  },
  "problem_contract_sha256": "fcaf1b38643508e0e5ebd0faf047f761b69bc7a698baf24bcf22cc2e2e9b8c08"
}
```
